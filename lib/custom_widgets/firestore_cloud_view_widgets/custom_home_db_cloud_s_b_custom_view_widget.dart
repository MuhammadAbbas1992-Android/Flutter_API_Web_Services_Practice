...
class CustomHomeDbCloudSBCustomViewWidget extends StatelessWidget {
  const CustomHomeDbCloudSBCustomViewWidget({
    super.key,
          ...
          builder: (context, snapshot) {
            ...
            return Obx(() => ListView.custom(
                childrenDelegate: SliverChildBuilderDelegate(
                    ...
                    childCount: homeDbCloudSBViewController.isAllData.value
