...
class GetSingleView extends StatefulWidget {
  const GetSingleView({super.key});

  @override
  State<GetSingleView> createState() => _GetSingleUser();
}

class _GetSingleUser extends State<GetSingleView> {
