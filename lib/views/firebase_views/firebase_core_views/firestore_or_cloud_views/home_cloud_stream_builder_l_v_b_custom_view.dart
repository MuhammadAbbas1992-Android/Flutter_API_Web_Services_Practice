...
import 'package:flutter_api_web_services_practice/custom_widgets/firestore_cloud_view_widgets/custom_home_db_cloud_s_b_custom_view_widget.dart';
...
class HomeCloudStreamBuilderLVBCustomView extends StatefulWidget {
  const HomeCloudStreamBuilderLVBCustomView({super.key});

  @override
  State<HomeCloudStreamBuilderLVBCustomView> createState() =>
      _HomeCloudStreamBuilderLVBCustomViewState();
}

class _HomeCloudStreamBuilderLVBCustomViewState
    extends State<HomeCloudStreamBuilderLVBCustomView> {
    ...
    return Scaffold(
      ...
      child: Column(
        children: [
          ...
          CustomHomeDbCloudSBCustomViewWidget(
            homeDbCloudSBViewController: homeDbCloudSBViewController,
          )
        ],
      ),
