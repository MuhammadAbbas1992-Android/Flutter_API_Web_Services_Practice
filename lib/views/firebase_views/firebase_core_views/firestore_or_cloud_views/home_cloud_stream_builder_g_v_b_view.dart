...
import 'package:flutter_api_web_services_practice/custom_widgets/firestore_cloud_view_widgets/custom_home_db_cloud_s_b_grid_view_widget.dart';
...
class HomeCloudStreamBuilderGVBView extends StatefulWidget {
  const HomeCloudStreamBuilderGVBView({super.key});

  @override
  State<HomeCloudStreamBuilderGVBView> createState() =>
      _HomeCloudStreamBuilderGVBViewState();
}

class _HomeCloudStreamBuilderGVBViewState
    extends State<HomeCloudStreamBuilderGVBView> {
    ...
    return Scaffold(
      ...
      child: Column(
        children: [
          ...
          CustomHomeDbCloudSBGridViewWidget(
            homeDbCloudSBViewController: homeDbCloudSBViewController,
          )
        ],
      ),
